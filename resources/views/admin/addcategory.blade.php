          ...
          <form role="form" action="<?php route('add.category') ?>" method="post" id="addcategory-form" autocomplete="off" 
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="category_slug" id="category_slug" class="form-control" required readonly placeholder="Category Slug">
              </div>
              <div class="form-group">
            ...
            <div class="card-footer">
              <button type="submit" id="add_category" disabled class="btn btn-primary">Submit</button>
            </div>
          </form>
        </div>
        <!-- /.card -->
