<!-- Footer Section Begin -->
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
                        <div class="footer__copyright__payment"><img src="{{ asset('resources/assets/images/payment-item.png') }}" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{ asset('resources/assets/js/mixitup.min.js') }}"></script>
